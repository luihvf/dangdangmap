    ...
    <div className="h-[100dvh] w-full relative overflow-hidden bg-gray-100">
      ...
      {!selectedPlace && !selectedHazard && (
        <button onClick={() => setShowReport(true)}
          className="absolute bottom-6 right-6 z-10 w-14 h-14 bg-brand-500 text-white rounded-2xl shadow-xl shadow-orange-300 flex items-center justify-center text-2xl hover:scale-105 transition-transform active:scale-95">+</button>
      )}
