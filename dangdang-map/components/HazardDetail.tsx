    ...
    <div className="bg-white rounded-t-3xl shadow-2xl slide-up">
      <div className="px-5 pt-4 pb-5">
        ...
        <div className="flex gap-3">
          <button className="flex-1 bg-red-500 text-white font-bold py-3 rounded-2xl hover:bg-red-600 transition-colors">
            ✅ 아직 위험해요
          </button>
          <button className="flex-1 bg-green-500 text-white font-bold py-3 rounded-2xl hover:bg-green-600 transition-colors">
            🙆 해결됐어요
          </button>
        </div>
      </div>
